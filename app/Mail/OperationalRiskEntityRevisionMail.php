...
class OperationalRiskEntityRevisionMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Complétion à revoir — '.($name !== '' ? $name : '#'.$this->row->id),
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.cartographie.risk-entity-revision',
            with: [
                'row' => $this->row,
