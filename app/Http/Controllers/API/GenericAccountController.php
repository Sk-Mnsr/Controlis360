...
class GenericAccountController extends APIController
{
    private const FIELD_RULES = [
        ...
        'forgotten' => 'nullable|string|max:20',
        ...
        'interactive_access' => 'nullable|string|max:20',
        'password_managed_by' => 'nullable|string|max:255',
        'mfa' => 'nullable|string|max:40',
        'logging_enabled' => 'nullable|string|max:20',
        'periodic_review' => 'nullable|string|max:20',
        'risk' => 'nullable|string|max:40',
