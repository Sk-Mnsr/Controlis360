<template>
    <div class="space-y-4">
        ...
        <div v-if="sortedComments.length" class="space-y-2">
            <h4 class="text-xs font-semibold uppercase tracking-wide text-slate-500">Commentaires régulateur</h4>
            <div
        ...
        <div v-if="canComment && rows.length" class="space-y-3">
                    ...
                    <div class="grid flex-1 gap-3 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea
                                ...
                                rows="3"
                                class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm"
                                placeholder="Répondre à l'audit ou au contrôle (avis avant clôture ou non)…"
                            />
                        </div>
                    </div>
                    <button
...
async function save() {
    ...
    try {
        await api.post(`/recommendations/${props.reco.id}/regulator-comments`, { entries });
        resetRows();
        emit('saved');
    } catch (err) {
